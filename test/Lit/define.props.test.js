describe( 'Lit.define - props', () => {
  ...
  it( '使用数组定义 props', () => {
    ...
    expect( lit.a ).is.equals( undefined );
    expect( lit.b ).is.equals( '3' );
    expect( lit.$props.a ).is.equals( undefined );
    expect( lit.$props.b ).is.equals( '3' );
  });
  ...
  it( '定义 prop 的类型为 String ( 写法一 )', () => {
    ...
    expect( lit.a ).is.equals( undefined );
    expect( lit.b ).is.equals( '' );
    expect( lit.c ).is.equals( '5' );
    expect( lit.$props.a ).is.equals( undefined );
    expect( lit.$props.b ).is.equals( '' );
    expect( lit.$props.c ).is.equals( '5' );
  });
  ...
  it( '定义 prop 的类型为 Boolean ( 写法一 )', () => {
    ...
    expect( lit.a ).is.equals( undefined );
    expect( lit.b ).is.equals( true );
    expect( lit.c ).is.equals( true );
    expect( lit.$props.a ).is.equals( undefined );
    expect( lit.$props.b ).is.equals( true );
    expect( lit.$props.c ).is.equals( true );
  });
  ...
  it( '定义 prop 的类型为 Number ( 写法一 )', () => {
    ...
    expect( lit.a ).is.equals( undefined );
    expect( lit.b ).is.equals( 0 );
    expect( lit.c ).is.equals( 5 );
    expect( lit.$props.a ).is.equals( undefined );
    expect( lit.$props.b ).is.equals( 0 );
    expect( lit.$props.c ).is.equals( 5 );
  });
  ...
  it( '使用自定义方法转换 prop 的类型 ( 写法一 )', () => {
    ...
    expect( lit.$props.a ).is.equals( 2 );
    expect( lit.$props.b ).is.equals( 3 );
    expect( lit.$props.c ).is.equals( 4 );
  });
  ...
  it( '定义 prop 的默认值为非引用类型时无要求', () => {
    ...
    expect( lit.b ).is.equals( 123 );
    expect( lit.c ).is.equals( false );
    expect( lit.d ).is.equals( true );
    expect( lit.e ).is.equals( null );
    expect( lit.$props.a ).is.equals( '123' );
    expect( lit.$props.b ).is.equals( 123 );
    expect( lit.$props.c ).is.equals( false );
    expect( lit.$props.d ).is.equals( true );
    expect( lit.$props.e ).is.equals( null );
  });
  ...
  it( '定义 prop 的默认值为引用类型时必须使用方法进行返回', () => {
    ...
    expect( lit.a ).is.equals( undefined );
    expect( lit.b ).is.equals( undefined );
    expect( lit.c ).is.equals( undefined );
    // expect( lit.d ).is.equals( [ 1, 2, 3 ] );
    expect( lit.e ).is.deep.equals( { a: 1, b: 2, c: 3 } );
    expect( lit.f ).is.deep.equals( /RegExp/ );
    expect( lit.g ).is.equals( ZenJS.noop );
    expect( lit.$props.a ).is.equals( undefined );
    expect( lit.$props.b ).is.equals( undefined );
    expect( lit.$props.c ).is.equals( undefined );
    expect( lit.$props.d ).is.deep.equals( [ 1, 2, 3 ] );
    expect( lit.$props.e ).is.deep.equals( { a: 1, b: 2, c: 3 } );
    expect( lit.$props.f ).is.deep.equals( /RegExp/ );
    expect( lit.$props.g ).is.equals( ZenJS.noop );
  });
  ...
  it( '定义 prop 的默认值后, 确保在已传入值时, 默认值不起作用', () => {
    ...
    expect( lit.a1 ).is.equals( '' );
    expect( lit.a2 ).is.equals( '' );
    expect( lit.a3 ).is.equals( 'b3' );
    expect( lit.a4 ).is.equals( true );
    expect( lit.a5 ).is.equals( true );
    expect( lit.a6 ).is.equals( true );
    expect( lit.a7 ).is.equals( 0 );
    expect( lit.a8 ).is.equals( 0 );
    expect( lit.a9 ).is.equals( 9 );
    expect( lit.b1 ).is.equals( 'c1' );
    expect( lit.b2 ).is.equals( 'c2' );
    expect( lit.b3 ).is.equals( 'c3' );
    expect( lit.b4 ).is.equals( 'c4' );
    expect( lit.b5 ).is.equals( 'c5' );
    expect( lit.b6 ).is.equals( 'c6' );
    expect( lit.b7 ).is.equals( 'c7' );
    expect( lit.b8 ).is.equals( 'c8' );
    expect( lit.b9 ).is.equals( 'c9' );
    expect( lit.$props.a1 ).is.equals( '' );
    expect( lit.$props.a2 ).is.equals( '' );
    expect( lit.$props.a3 ).is.equals( 'b3' );
    expect( lit.$props.a4 ).is.equals( true );
    expect( lit.$props.a5 ).is.equals( true );
    expect( lit.$props.a6 ).is.equals( true );
    expect( lit.$props.a7 ).is.equals( 0 );
    expect( lit.$props.a8 ).is.equals( 0 );
    expect( lit.$props.a9 ).is.equals( 9 );
    expect( lit.$props.b1 ).is.equals( 'c1' );
    expect( lit.$props.b2 ).is.equals( 'c2' );
    expect( lit.$props.b3 ).is.equals( 'c3' );
    expect( lit.$props.b4 ).is.equals( 'c4' );
    expect( lit.$props.b5 ).is.equals( 'c5' );
    expect( lit.$props.b6 ).is.equals( 'c6' );
    expect( lit.$props.b7 ).is.equals( 'c7' );
    expect( lit.$props.b8 ).is.equals( 'c8' );
    expect( lit.$props.b9 ).is.equals( 'c9' );
  });
  ...
  it( '定义 prop 的默认值时, 在使用方法进行返回默认值时, this 指向的是 $lit', () => {
    ...
    expect( lit.$props.a ).is.equals( lit );
  });
  ...
  it( '首字母为 $ 的 prop 可以在 $props 下找到, 但是不能在 $lit 下找到', () => {
    ...
    expect( lit.a ).is.equals( undefined );
    expect( lit.b ).is.equals( '4' );
    expect( lit.$a ).is.equals( undefined );
    expect( lit.$b ).is.equals( undefined );
    expect( lit.$props.a ).is.equals( undefined );
    expect( lit.$props.b ).is.equals( '4' );
    expect( lit.$props.$a ).is.equals( undefined );
    expect( lit.$props.$b ).is.equals( '3' );
  });
  ...
  it( '定义了 attr 参数则会从相应的 attribute 中取值', () => {
    ...
    expect( lit[ 'a' ] ).is.equals( '2' );
    expect( lit[ 'b' ] ).is.equals( '1' );
    expect( lit[ 'aB' ] ).is.equals( '4' );
    expect( lit[ 'aC' ] ).is.equals( '3' );
    expect( lit.$props[ 'a' ] ).is.equals( '2' );
    expect( lit.$props[ 'b' ] ).is.equals( '1' );
    expect( lit.$props[ 'aB' ] ).is.equals( '4' );
    expect( lit.$props[ 'aC' ] ).is.equals( '3' );
  });
  ...
  it( '未定义 attr 参数则会将当前 prop 的名称转为以连字符号连接的小写 attr 名称', () => {
    ...
    expect( lit[ 'aB' ] ).is.equals( '2' );
    expect( lit[ 'a-c' ] ).is.equals( '3' );
    expect( lit.$props[ 'a' ] ).is.equals( '1' );
    expect( lit.$props[ 'aB' ] ).is.equals( '2' );
    expect( lit.$props[ 'a-c' ] ).is.equals( '3' );
  });
  ...
  it( '支持传入名称为 Symbol 类型的 prop, 可以使用默认值给名称为 Symbol 类型的 prop 赋值', () => {
    ...
    expect( lit[ a ] ).is.equals( 1 );
    expect( lit[ b ] ).is.equals( 2 );
    expect( lit.$props[ a ] ).is.equals( 1 );
    expect( lit.$props[ b ] ).is.equals( 2 );
  });
  ...
  it( '支持传入名称为 Symbol 类型的 prop, 可以指定 attr 属性使当前 prop 从指定 attribute 取值', () => {
    ...
    expect( lit[ a ] ).is.equals( 'd' );
    expect( lit[ b ] ).is.equals( 'e' );
    expect( lit.$props[ a ] ).is.equals( 'd' );
    expect( lit.$props[ b ] ).is.equals( 'e' );
  });
  ...
  it( '更改自定义元素的 attribute 属性值时, 会立即将改变更新到内部的值中 ( 非 Symbol 类型 )', () => {
    ...
    expect( lit.a ).is.equals( '1' );
    expect( lit.aB ).is.equals( '2' );
    expect( lit.attr1 ).is.equals( '6' );
    expect( lit.attr2 ).is.equals( '5' );
    expect( lit.$props.a ).is.equals( '1' );
    expect( lit.$props.aB ).is.equals( '2' );
    expect( lit.$props.attr1 ).is.equals( '6' );
    expect( lit.$props.attr2 ).is.equals( '5' );
    ...
    expect( lit.a ).is.equals( '2' );
    expect( lit.aB ).is.equals( '3' );
    expect( lit.attr1 ).is.equals( '6' );
    expect( lit.attr2 ).is.equals( '5' );
    expect( lit.$props.a ).is.equals( '2' );
    expect( lit.$props.aB ).is.equals( '3' );
    expect( lit.$props.attr1 ).is.equals( '6' );
    expect( lit.$props.attr2 ).is.equals( '5' );
    ...
    expect( lit.a ).is.equals( '2' );
    expect( lit.aB ).is.equals( '3' );
    expect( lit.attr1 ).is.equals( '8' );
    expect( lit.attr2 ).is.equals( '7' );
    expect( lit.$props.a ).is.equals( '2' );
    expect( lit.$props.aB ).is.equals( '3' );
    expect( lit.$props.attr1 ).is.equals( '8' );
    expect( lit.$props.attr2 ).is.equals( '7' );
  });
  ...
  it( '更改自定义元素的 attribute 属性值时, 会立即将改变更新到内部的值中 ( Symbol 类型 )', () => {
    ...
    expect( lit[ a ] ).is.equals( undefined );
    expect( lit[ b ] ).is.equals( '1' );
    expect( lit[ c ] ).is.equals( 2 );
    expect( lit.$props[ a ] ).is.equals( undefined );
    expect( lit.$props[ b ] ).is.equals( '1' );
    expect( lit.$props[ c ] ).is.equals( 2 );
    ...
    expect( lit.$props[ a ] ).is.equals( undefined );
    expect( lit.$props[ b ] ).is.equals( '2' );
    expect( lit.$props[ c ] ).is.equals( 3 );
  });
  ...
  it( '可以使用 attr 属性将多个 prop 绑定到一个 attribute 上, 当 attribute 更改时, 所有绑定到 attribute 上的 prop 均会更新', () => {
    ...
    expect( lit[ a ] ).is.equals( '1' );
    expect( lit[ 'a' ] ).is.equals( '1' );
    expect( lit[ 'aB' ] ).is.equals( 1 );
    expect( lit.$props[ a ] ).is.equals( '1' );
    expect( lit.$props[ 'a' ] ).is.equals( '1' );
    expect( lit.$props[ 'aB' ] ).is.equals( 1 );
