(function (chai) {
  ...
  describe( 'Hu.static', () => {
    ...
    it( 'Hu.util.toString: 将值转为字符串形式', () => {
      ...
      chai.expect( Hu.util.toString( Symbol() ) ).is.equals('Symbol()');
    ...
    it( 'Hu.util.isEqual: 判断传入的两个值是否相等', () => {
      ...
      chai.expect( Hu.util.isEqual( Symbol(), Symbol() ) ).is.false;
      ...
      chai.expect( Hu.util.isEqual( function(){}, function(){} ) ).is.false;
    });
    ...
    it( 'Hu.util.isNotEqual: 判断传入的两个值是否不相等', () => {
      ...
      chai.expect( Hu.util.isNotEqual( Symbol(), Symbol() ) ).is.true;
      ...
      chai.expect( Hu.util.isNotEqual( function(){}, function(){} ) ).is.true;
    });
